...
module.exports = class init1642869230940 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`permission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`permissionKey\` varchar(255) NOT NULL, \`parentKey\` varchar(50) NULL, \`isParent\` tinyint NOT NULL, \`menuId\` int NULL, UNIQUE INDEX \`REL_276b5d6df236e69df2a2fa950e\` (\`menuId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`role_and_permission\` (\`id\` int NOT NULL AUTO_INCREMENT, \`permissionId\` int NOT NULL, \`roleId\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`order\` (\`id\` int NOT NULL AUTO_INCREMENT, \`order_no\` varchar(36) NOT NULL, \`orderChannel\` enum ('TELEGRAM', 'YEMEKSEPETI', 'GETIR', 'PANEL') NOT NULL, \`paymentMethod\` enum ('OnDelivery', 'ONLINE') NOT NULL, \`totalPrice\` decimal(8,2) NOT NULL DEFAULT '0.00', \`orderStatus\` smallint NOT NULL DEFAULT '0', \`createDate\` datetime NOT NULL, \`note\` varchar(4000) NULL, \`cancel_reason\` varchar(4000) NULL, \`customer_id\` int NOT NULL, \`getirOrderId\` varchar(255) NULL, \`merchantId\` int NOT NULL, UNIQUE INDEX \`REL_60c614712f96cf7ca323ada03f\` (\`getirOrderId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`thumbUrl\` varchar(255) NULL, \`title\` varchar(50) NOT NULL, \`description\` varchar(500) NOT NULL, \`unitPrice\` decimal NOT NULL DEFAULT '0', \`categoryId\` int NOT NULL, \`merchantId\` int NULL, \`getirProductId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`ALTER TABLE \`permission\` ADD CONSTRAINT \`FK_276b5d6df236e69df2a2fa950e8\` FOREIGN KEY (\`menuId\`) REFERENCES \`menu\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`role_and_permission\` ADD CONSTRAINT \`FK_be903fdc2a1b747959235bb3558\` FOREIGN KEY (\`permissionId\`) REFERENCES \`permission\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE \`role_and_permission\` ADD CONSTRAINT \`FK_1412db6c43dc5be5c275f10dae7\` FOREIGN KEY (\`roleId\`) REFERENCES \`role\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    //    await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (29, 'UPATE_PERMISSIONS', 'SHOW_ROLE', 0, NULL);`);
       ...
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (33, 'DELETE_CATEGORY', 'SHOW_CATEGORY', 0, NULL);`);
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (34, 'SHOW_PRODUCT', NULL, 1, 6);`);
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (35, 'ADD_PRODUCT', 'SHOW_PRODUCT', 0, NULL);`);
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (36, 'UPDATE_PRODUCT', 'SHOW_PRODUCT', 0, NULL);`);
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (37, 'DELETE_PRODUCT', 'SHOW_PRODUCT', 0, NULL);`);
       await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (38, 'SHOW_ORDER', NULL, 1, 7);`);
    ...
    //    await queryRunner.query(`INSERT INTO \`permission\` (\`id\`, \`PermissionKey\`, \`ParentKey\`, \`IsParent\`, \`menuId\`) VALUES (43, 'SHOW_YEMEK_SEPETI_ENTEGRATION', NULL, 1, 11);`);
       ...
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (13, 33, 1);`);
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (14, 34, 1);`);
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (15, 35, 1);`);
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (16, 36, 1);`);
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (17, 37, 1);`);
       await queryRunner.query(`INSERT INTO \`role_and_permission\` (\`id\`, \`permissionId\`, \`roleId\`) VALUES (18, 38, 1);`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE \`role_and_permission\` DROP FOREIGN KEY \`FK_1412db6c43dc5be5c275f10dae7\``);
        await queryRunner.query(`ALTER TABLE \`role_and_permission\` DROP FOREIGN KEY \`FK_be903fdc2a1b747959235bb3558\``);
        await queryRunner.query(`ALTER TABLE \`permission\` DROP FOREIGN KEY \`FK_276b5d6df236e69df2a2fa950e8\``);
