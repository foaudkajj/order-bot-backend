...
module.exports = class init1642869230940 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE \`product\` (\`id\` int NOT NULL AUTO_INCREMENT, \`tgQueryResult\` varchar(15) NULL, \`thumbUrl\` varchar(255) NOT NULL, \`title\` varchar(50) NOT NULL, \`description\` varchar(500) NOT NULL, \`productCode\` varchar(50) NOT NULL, \`unitPrice\` decimal NOT NULL DEFAULT '0', \`categoryId\` int NOT NULL, \`merchantId\` int NULL, \`getirProductId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
