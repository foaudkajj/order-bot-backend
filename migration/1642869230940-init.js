...
module.exports = class init1642869230940 {
    ...
    async up(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (3, 'ADMIN_MENUS', 'user', NULL, 'NAV.ADMIN_MENUS', NULL, NULL, 1, 1);`);
        await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (4, 'PRODUCTS_MANAGEMENT', 'fa-solid fa-box', NULL, 'NAV.PRODUCTS_MANAGEMENT', NULL, NULL, 1, 2);`);
        ...
        await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (7, 'ORDERS', 'cart', NULL, 'NAV.ORDERS', '/orders', NULL, 0, 0);`);
