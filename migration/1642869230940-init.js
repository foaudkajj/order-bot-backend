...
module.exports = class init1642869230940 {
    ...
    async up(queryRunner) {
       ...
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (1, 'ROLE_MANAGEMENT', NULL, NULL, 'NAV.ROLE_MANAGEMENT', 'rolemanagement', 'ADMIN_MENUS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (2, 'USER_MANAGEMENT', NULL, NULL, 'NAV.USER_MANAGEMENT', 'usermanagement', 'ADMIN_MENUS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (3, 'ADMIN_MENUS', NULL, NULL, 'NAV.ADMIN_MENUS', NULL, NULL, 1, 1);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (4, 'SETTINGS', NULL, NULL, 'NAV.SETTINGS', NULL, NULL, 1, 2);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (5, 'CATEGORIES', NULL, NULL, 'NAV.CATEGORIES', 'bot/categories', 'SETTINGS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (6, 'PRODUCTS', NULL, NULL, 'NAV.PRODUCTS', 'bot/products', 'SETTINGS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (7, 'ORDERS', NULL, NULL, 'NAV.ORDERS', 'bot/orders', 'SETTINGS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (8, 'TELEGRAM_SETTINGS', NULL, NULL, 'NAV.TELEGRAM_SETTINGS', 'bot/telegramsettings', 'SETTINGS', 0, 0);`);
       await queryRunner.query(`INSERT INTO \`menu\` (\`Id\`, \`MenuKey\`, \`Icon\`, \`Title\`, \`Translate\`, \`URL\`, \`ParentId\`, \`IsParent\`, \`Priority\`) VALUES (9, 'ENTEGRATIONS', NULL, NULL, 'NAV.ENTEGRATIONS', NULL, NULL, 1, 3);`);
