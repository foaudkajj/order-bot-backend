...
export class CategoryController {
    ...
    async Get(@Query() query: DataSourceLoadOptionsBase): Promise<UIResponseBase<Category>> {
    ...
    async Update(@Body() request: DxGridUpdateRequest): Promise<UIResponseBase<Category>> {
        let entity = { ...JSON.parse(request.values) } as Category;
    ...
    async Delete(@Body() deleteRequest: DxGridDeleteRequest): Promise<UIResponseBase<Category>> {
